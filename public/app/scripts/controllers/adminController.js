...
angular.module('intranetMaterialApp').controller('PermissionController', ['$scope', '$http', 'ManagePermission', '$resource', 'Permission', 'UpdateRole', 'UpdateUser',
  function($scope, $http, ManagePermission, $resource, Permission, UpdateRole, UpdateUser) {
    $scope.package = {
      name: 'permission'
    };
